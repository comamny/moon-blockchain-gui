...
import moonToMojo from '../../utils/moonToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isMoonCurrency = ['MOC', 'TMOC'].includes(currencyCode);
  const mojo = isMoonCurrency
    ? moonToMojo(correctedValue)
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isMoonCurrency ? 12 : 3,
