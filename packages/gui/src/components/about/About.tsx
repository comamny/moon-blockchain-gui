...
import icon from '../../assets/img/moon_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) {currentYear} Moon Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/MOONCOINTEAM/moon-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
