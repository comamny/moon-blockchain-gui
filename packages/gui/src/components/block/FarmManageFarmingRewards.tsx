...
import { Button, Flex, Form, TextField, Loading } from '@moon/core';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@moon/api-react';
import {
  Alert,
  Dialog,
  DialogActions,
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    0.25MOC reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
