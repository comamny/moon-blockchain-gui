...
import type { NFTInfo, Wallet } from '@moon/api';
import {
...
/*       An NFT offer consists of a single NFT being offered for MOC/CAT      */
/* ========================================================================== */
    ...
    if (
      ...
      switch (tokenWalletInfo.walletType) {
        case WalletType.STANDARD_WALLET:
          balanceString = mojoToMoonLocaleString(
            walletBalance.spendableBalance,
            locale,
          );
          balance = mojoToMoon(walletBalance.spendableBalance);
          break;
        case WalletType.CAT:
...
/* ========================================================================== */
/*                              NFT Offer Editor                              */
/*           Currently only supports a single NFT <--> MOC/CAT offer          */
/* ========================================================================== */
