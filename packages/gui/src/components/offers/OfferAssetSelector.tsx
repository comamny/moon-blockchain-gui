...
import { Wallet, WalletType, type CATToken } from '@moon/api';
import { useGetCatListQuery, useGetWalletsQuery } from '@moon/api-react';
import { Trans } from '@lingui/macro';
import { FormControl, InputLabel, MenuItem } from '@mui/material';
import { Select, useCurrencyCode } from '@moon/core';
