...
import { useCreateOfferForIdsMutation } from '@moon/api-react';
...
import { moonToMojo, catToMojo } from '@moon/core';
...
function OfferEditor(props: OfferEditorProps) {
  ...
  async function onSubmit(formData: FormData) {
    ...
    let feeInMojos = moonToMojo(formData.fee ?? 0);
