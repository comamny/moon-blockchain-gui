...
import { OfferTradeRecord, toBech32m } from '@moon/api';
import {
  Button,
  Checkbox,
  Dialog,
...
const testnetDummyHost = 'offers-api-sim.mooncoin.top';
...
async function postToOfferBin(
  ...
  if (testnet) {
    return 'https://www.mooncoin.top/offers';
  }
...
enum HashgreenErrorCodes {
  ...
  MARKET_NOT_FOUND = 50029, // Pairing doesn't exist e.g. MOC/RandoCoin
...
const KeybaseTeamName = 'moon_offers';
...
function OfferShareKeybaseDialog(props: OfferShareServiceDialogProps) {
  ...
  const teamName = testnet ? 'testmocoffersdev' : KeybaseTeamName;
