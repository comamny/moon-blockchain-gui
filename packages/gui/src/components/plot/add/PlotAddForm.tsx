...
import { defaultPlotter, toBech32m, fromBech32m } from '@moon/api';
import {
  useStartPlottingMutation,
  useCreateNewPoolWalletMutation,
} from '@moon/api-react';
import { useForm, SubmitHandler } from 'react-hook-form';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@moon/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.MOONPOS),
  });
