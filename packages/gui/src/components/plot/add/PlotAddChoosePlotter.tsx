...
import { CardStep, Select, StateColor } from '@moon/core';
import { useGetPlottersQuery } from '@moon/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@moon/api';
import type { Plotter, PlotterMap } from '@moon/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    // Sort moonpos to the top of the list
    displayablePlotters.sort((a, b) => a == PlotterName.MOONPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Moon Proof of Space plotter. If unsure,
            use the default Moon Proof of Space plotter.
        </Trans>
      </Typography>
