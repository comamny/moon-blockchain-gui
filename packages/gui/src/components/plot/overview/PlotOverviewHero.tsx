...
import { useRefreshPlotsMutation } from '@moon/api-react';
import { Grid, Typography, Divider } from '@mui/material';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@moon/core';
import { Plots } from '@moon/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              Plots are allocated space on your hard drive used to farm and earn Moon.
              &nbsp;
              <Link
                target="_blank"
                href="https://github.com/MOONCOINTEAM/moon-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
