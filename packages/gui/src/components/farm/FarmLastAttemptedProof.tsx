...
import { Link, Table, Card } from '@moon/core';
import { useGetFarmingInfoQuery } from '@moon/api-react';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/MOONCOINTEAM/moon-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
