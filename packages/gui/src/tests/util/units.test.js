...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of moon', () => {
      const result = units.getUnit('moon');
    ...
    it('gets unit of moon using alias', () => {
      const result = units.getUnit('mc');
  ...
  describe('#getDisplay', () => {
    it('gets display of moon', () => {
      const result = units.getDisplay('moon');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('moon', 9);

      const result = units.getUnit('moon');

      expect(result).toEqual(9);

      units.setUnit('moon', 1);
    });
  });
  describe('#setDisplay', () => {
