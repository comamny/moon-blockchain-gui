...
This library provides react hooks on the top of @moon/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under do hood.
...
- Automatically refresh queries when data changed (using events from Moon Blockchain).
...
import { useGetPublicKeysQuery } from '@moon/api-react';
...
import { store, api } from '@moon/api-react';
