...
import { Back, Flex, Loading, useShowError } from '@moon/core';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@moon/api-react';
import WalletCreateCard from '../create/WalletCreateCard';
import isCATWalletPresent from '../../utils/isCATWalletPresent';
import type { CATToken } from '@moon/api';
import useWalletState from '../../hooks/useWalletState';
import { SyncingStatus } from '@moon/api';
