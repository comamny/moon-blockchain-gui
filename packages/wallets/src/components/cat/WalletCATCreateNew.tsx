...
import { moonToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@moon/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = moonToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New Moon Asset Token Wallet</Trans>
        </Back>
        <Card>
