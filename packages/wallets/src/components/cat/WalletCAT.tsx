...
import { Flex, Loading, useOpenDialog } from '@moon/core';
...
import { useSetCATNameMutation, useGetCatListQuery } from '@moon/api-react';
import { Offers as OffersIcon } from '@moon/icons';
