...
export default function WalletStandardCards(props: Props) {
  ...
  return (
    <WalletCards
      ...
      totalBalanceTooltip={
        <Trans>
          This is the total amount of moon in the blockchain at the current peak
      ...
      spendableBalanceTooltip={
        <Trans>
          This is the amount of Moon that you can currently use to make
          transactions. It does not include pending farming rewards, pending
          incoming transactions, and Moon that you have just spent but is not
